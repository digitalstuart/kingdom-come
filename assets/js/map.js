...
function initMap() {
    ...
    let map = new google.maps.Map(document.getElementById('map'), {
        ...
        let placesObject = JSON.parse(places);
        
        for (let i = 0; i < placesObject.placesString.length; i++) {
            let lat = placesObject.placesString[i].lat;
            let lng = placesObject.placesString[i].lng;
            ...
            let mapContent = placesObject.placesString[i].formatted_address + " " + placesObject.placesString[i].name;
        ...
        for (var i=0; i < placesObject.placesString.length; i++) {

          if (placesObject.placesString[i].category == 'restaurants') {
